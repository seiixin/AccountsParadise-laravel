  ...
  return (
    <div className="min-h-screen bg-gradient-app text-neutral-100">
      ...
      <div className="mx-auto max-w-7xl p-4 md:p-6">
        ...
        {/* Desktop Layout (identical structure) */}
        <div className="hidden lg:flex gap-6">
          ...
          <div className="flex-1">
            {header}
            <div className="mt-4 glass-soft rounded-lg p-4">
              {children}
            </div>
          </div>
        </div>
        ...
        <div className="lg:hidden">
          {header}
          <div className="mt-3 glass-soft rounded-lg p-4">
            {children}
          </div>
        </div>
      </div>

      {/* Mobile Drawer (same as Buyer) */}
      {mobileOpen && (
